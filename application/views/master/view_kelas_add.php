<?php $this->load->view('header'); ?>
  ...
  <script type="text/javascript">
	...
	function getDateTime($tgl) {
  	...
  	function saveKelas() {
        ...
        type:"POST",
        data : dataArray,
        url:'<?php echo base_url('kelas/saveKelas'); ?>',
  ...
  <div class="content-wrapper">
  	...
  	<section class="content-header">
  		...
  		<ol class="breadcrumb">
  			<li><a href="<?php echo base_url('kelas');?>"><i class="fa fa-dashboard"></i> Kelas</a></li>
  			...
  			<div class="col-md-12">
  				...
  				<div class="box box-info">
  						...
  						<div class="box-body">
  							<div class="col-sm-12">
  								<div class="form-group">
  									...
  									<div class="col-sm-8">
  										<input type="text" class="form-control" id="idKelas" placeholder="ID Kelas" value="<?php echo $idKelas; ?>" disabled>
  									</div>
  								</div>
  									...
  									<div class="col-sm-8">
  										<select class="form-control" id="pengajar">
                                            ...
                                            <?php for($a=0; $a<count($user); $a++){  ?>
  											    <option value="<?php echo $user[$a]['iduser'] ?>"><?php echo $user[$a]['realname'] ?></option>
                                            <?php } ?>
  										</select>
  									</div>
  								</div>                               
  					...
  					<div class="box-footer">
  						<button type="submit" class="btn btn-info pull-right" onclick="saveKelas()">Simpan</button>
  					</div>
  					<!-- /.box-footer -->
  				</div>
  			</div>
