                        ...
                        <div class="box-body">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="idPembayaran" placeholder="ID Pembayaran" value="<?php echo $idPembayaran; ?>" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <select name="masa" class="form-control  input-lg select2" id="masa" required>
                                            ...
                                            <option value="01-2022">Januari - 2022</option>
                                            <option value="02-2022">Februari - 2022</option>
                                            <option value="03-2022">Maret - 2022</option>
                                            <option value="04-2022">April - 2022</option>
                                            <option value="05-2022">Mei - 2022</option>
                                            <option value="06-2022">Juni - 2022</option>
                                            <option value="07-2022">Juli - 2022</option>
                                            <option value="08-2022">Agustus - 2022</option>
                                            <option value="09-2022">September - 2022</option>
                                            <option value="10-2022">Oktober - 2022</option>
                                            <option value="11-2022">November - 2022</option>
                                            <option value="12-2022">Desember - 2022</option>
